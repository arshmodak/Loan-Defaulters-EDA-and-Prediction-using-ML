...
loan_credit = pd.read_csv(r'E:\ARSH\Imarticus\Python\PythonProject\XYZCorp_LendingData.txt', delimiter = '\t', na_values = 'NaN', index_col = 0)
loan_credit.head()
...
# Metrics used for the aforementioned Logistic Regression Model : 
...
print("Accuracy of the Model: ", acc) # 99.87
...
# Metrics used for the aforementioned Naive Bayes Model :

from sklearn.metrics import confusion_matrix, accuracy_score, classification_report

cfm = confusion_matrix(Y_test, Y_pred_NB)
print("Confusion Matrix: ")
print()
print(cfm)
...
print("Accuracy of the Model: ", acc)  #99.86
...
cfm = confusion_matrix(Y_test, Y_predETC)
print("Confusion Matrix: ")
print()
print(cfm)
...
acc = accuracy_score(Y_test, Y_predETC)
print("Accuracy of the Model: ", acc) # 59.123
...
cfm = confusion_matrix(Y_test, Y_predRFC)
print("Confusion Matrix: ")
print()
print(cfm)
...
print("Accuracy of the Model: ", acc)   # 99.838
...
print("Accuracy of the Model: ", acc) #99.68 for both gini and entropy
...
cfm = confusion_matrix(Y_test, Y_predAB)
print("Confusion Matrix: ")
print()
print(cfm)
...
acc = accuracy_score(Y_test, Y_predAB)
print("Accuracy of the Model: ", acc) # 99.60
...
print("Accuracy of the Model: ", acc)  # 99.59
